    ...
    events: {
      render: function () {
        ...
        if (!chart.labelBg) {
          ...
          chart.labelTxt.attr({
            text: formatPrice(lastPoint.y.toFixed(2)),
          });
        }
        ...
        if (!chart.labelTxt) {
          chart.labelTxt = renderer
            .text(formatPrice(lastPoint.y.toFixed(2)), 0, 0)
            .css({
              fontSize: "18px",
              color: "#ffffff",
              fontWeight: "normal",
    ...
    formatter: function () {
      ...
      if (!chart.hoverText) {
        chart.hoverText = renderer
          .text(formatPrice(point.y.toFixed(2)), 0, 0)
          .css({
            fontSize: "18px",
            color: "#ffffff",
            fontWeight: "normal",
      ...
      chart.hoverText
        .attr({
          text: formatPrice(point.y.toFixed(2)),
